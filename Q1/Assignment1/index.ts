...
async function getUserInput(): Promise<{ firstNumber: number; secondNumber: number; operationType: Operation }> {
    ...
    return userInput as { firstNumber: number; secondNumber: number; operationType: Operation };
}

// Function to perform calculations based on user input
function performCalculation(firstNumber: number, secondNumber: number, operationType: Operation): number {
